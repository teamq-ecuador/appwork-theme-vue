<template>
  <div>
    <div class="media align-items-center py-3 mb-4">
      <img :src="`${publicUrl}img/uikit/${productImage}`" alt="" class="d-block ui-w-80 ui-bordered">
        ...
        <b-card-body>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4" v-for="i in productData.images" :key="i.image">
              <a :href="`${publicUrl}img/uikit/${i.image}`" :class="{'border-primary': i.primary}" target="_blank" class="d-block ui-bordered">
                <img :src="`${publicUrl}img/uikit/${i.image}`" class="img-fluid" alt="">
              </a>
            </div>
