<template>
  <div class="ui-block">
    ...
    <div class="cui-example">
      ...
      <h6>Table options</h6>
      <div class="mb-4">
        <b-check class="d-inline-block mr-3" v-model="isStickyHeader">Sticky header</b-check>
        <b-check class="d-inline-block mr-3" v-model="isSortable">Sortable</b-check>
        <b-check class="d-inline-block mr-3" v-model="isSortIconLeft" :disabled="!isSortable">Sort icons on the left</b-check>
        ...
        <b-check class="d-inline-block mr-3" v-model="isSelectable">Selectable</b-check>
...
export default {
  ...
  computed: {
    ...
    tableFields () {
      ...
      return Object.keys(this.jsonData[0]).map(key => ({
        key,
