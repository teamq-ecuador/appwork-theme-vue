<template>
  <div>
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-3 mb-4">
      <div>Products</div>
      <b-btn variant="primary rounded-pill" class="d-block"><span class="ion ion-md-add"></span>&nbsp; Add product</b-btn>
    </h4>
        ...
        <b-table
          ...
          <template v-slot:cell(title)="data">
            <div class="media align-items-center">
              <img class="d-block ui-w-40" :src="`${publicUrl}img/uikit/${data.item.image}`" alt="">
              <!-- Generate link to product here -->
              <a href="javascript:void(0)" class="media-body d-block text-body ml-3">{{data.item.title}}</a>
            </div>
          </template>
