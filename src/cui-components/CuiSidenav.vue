<template>
  <div class="ui-block">
        ...
        <div class="sidenav-inner">
          <sidenav-block class="my-1">
            <div class="media align-items-center ie-mh-1">
              <img :src="`${publicUrl}img/avatars/1-small.png`" class="d-block ui-w-50 rounded-circle" alt="">
    ...
    <div class="cui-example">
      ...
      <sidenav class="sidenav-dark d-inline-flex ui-bg-cover ui-bg-overlay-container mr-4 mb-4" :style="`background-image: url('${publicUrl}img/bg/1.jpg'); height: 450px`" :class="{ 'sidenav-collapsed': sidenav6Collapsed }">
      ...
      <sidenav class="sidenav-dark d-inline-flex ui-bg-cover ui-bg-overlay-container mr-4 mb-4" :style="`background-image: url('${publicUrl}img/bg/13.jpg'); height: 450px`" :class="{ 'sidenav-collapsed': sidenav6Collapsed }">
      ...
      <sidenav class="sidenav-light d-inline-flex ui-bg-cover ui-bg-overlay-container mr-4 mb-4" :style="`background-image: url('${publicUrl}img/bg/16.jpg'); height: 450px`" :class="{ 'sidenav-collapsed': sidenav6Collapsed }">
